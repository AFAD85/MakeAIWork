...
class ControlServer:
# De control server zet per world.period (0.02 sleep, ik denk 2 ms?) de actuators van de stuurhoek en de doelsnelheid op waardes, afhankelijk van de input van de sensoren ##nog niet af
    def __init__ (self):
