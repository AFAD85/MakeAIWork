...
'''
#pickle om het model in te kunnen voeren
import pickle as pi
#sklearn om het model te kunnen aanspreken
import sklearn as sk
from sklearn.neural_network import MLPClassifier
#degene hieronder is denk ik overbodig?
...
# uitkomst van het model adhv input bepaalt de steering angle hieronder:        
        self.steeringAngle = model.predict(self.sonarDistances)
